...
> **Current Track:** `v0.19.1` is the stable maintenance release, and `v0.19.0-rc.7` remains published on the isolated beta/RC channel. `v0.18.0` remains withdrawn. Submit feedback via [GitHub Issues](https://github.com/jasoncavinder/Helm/issues/new/choose).

## Active and Planned

| Version | Milestone |
|---|---|
| 0.19.x | Native Experience Foundation & First-Run Value — native app shell, commands, Settings/window behavior, Environment Brief, and stability baselines (stable latest patch `v0.19.1`; `v0.19.0-rc.7` retained on beta/RC) |
