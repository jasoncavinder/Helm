...
Helm is in active pre-1.0 development at **v0.10.0-beta.1**. Ten managers are functional with authority-ordered refresh, progressive search, pin/safe-mode policy controls, and broad localization coverage. See the [roadmap](/roadmap/) for what's next.
