...
Helm is in active pre-1.0 development at **v0.12.0**. Fifteen managers are functional with authority-ordered refresh, progressive search, pin/safe-mode policy controls, broad localization coverage, and dedicated upgrade-preview/dry-run UI. See the [roadmap](/product-roadmap/) for what's next.
