...
<CardGrid stagger>
	<Card title="Unified Control Plane" icon="laptop">
		Manage Homebrew, mise, rustup, and more from one native macOS menu bar app. No more switching between terminals.
	</Card>
...
Helm is in active pre-1.0 development at **v0.6.0**. Homebrew, mise, and rustup adapters are functional with authority-ordered refresh. See the [roadmap](/Helm/roadmap/) for what's next.
