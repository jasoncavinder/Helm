...
Helm is in active pre-1.0 development at **v0.7.0**. Five adapters are functional (Homebrew, mise, rustup, softwareupdate, mas) with authority-ordered refresh and restart-required detection. See the [roadmap](/roadmap/) for what's next.
