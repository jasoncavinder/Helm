...
Helm `v0.17.7` supports twenty-eight managers:
...
> **Current Track:** `v0.17.7` is the latest stable release on `main`; `0.18.x` planning is in progress. Please report issues at [GitHub Issues](https://github.com/jasoncavinder/Helm/issues/new/choose).
