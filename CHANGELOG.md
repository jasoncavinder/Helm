...
- Plan retains its native authority-grouped outline, keyboard behavior, and virtualized scrolling while presenting updates as a Wayfinder vertical card list with visible authority headings, secondary manager labels, balanced selection treatment, and no spreadsheet-style header or grid.
