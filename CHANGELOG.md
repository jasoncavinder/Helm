...
- Task diagnostics show localized guidance for unsupported pnpm global mutations and missing Apple developer tools, including failures that occur before any subprocess output exists.
