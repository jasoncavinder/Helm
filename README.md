...
<p align="center">
  ...
  <br>
  <strong>Pre-1.0 &middot; v0.13.0-rc.2</strong>
</p>
...
> **Status:** Active pre-1.0 development at `v0.13.0-rc.2`. Fifteen managers are functional with authority-ordered refresh, progressive search, pin/safe-mode policy controls, and localization coverage for `en`, `es`, `de`, `fr`, `pt-BR`, and `ja`.
>
> **Testing:** Please test `v0.13.0-rc.2` and report issues at [GitHub Issues](https://github.com/jasoncavinder/Helm/issues/new/choose).
...
| 0.13.x | UI/UX Analysis & Redesign — full UX audit, interaction model, information architecture refresh | In Progress (`v0.13.0-rc.2`) |
