...
<p align="center">
  ...
  <br>
  <strong>Pre-1.0 &middot; v0.17.5</strong>
</p>
...
> **Status:** Active pre-1.0 development with stable `v0.17.5` on `main` and post-`0.17.x` planning on `dev`.
>
> **Testing:** Please test `v0.17.5` and report issues at [GitHub Issues](https://github.com/jasoncavinder/Helm/issues/new/choose).
...
| 0.17.x | Diagnostics & Logging — log viewer, structured error export, health panel | Completed (`v0.17.x` stable, latest patch `v0.17.5`) |
