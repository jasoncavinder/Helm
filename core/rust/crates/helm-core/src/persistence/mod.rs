...
use crate::models::{
    CachedSearchResult, CoreError, InstalledPackage, ManagerId, OutdatedPackage, PinRecord,
    TaskRecord,
};
...
pub trait TaskStore: Send + Sync {
    ...
    /// Delete completed/failed/cancelled tasks older than `max_age_secs` seconds.
