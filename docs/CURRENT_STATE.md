...
- `v0.18.1` hotfix scope: reconcile the known development migration `17` collision before released doctor/repair migrations run, restoring service initialization, Refresh task submission, and CLI installation without resetting user data.
