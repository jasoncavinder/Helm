...
- prepared maintenance candidate: **0.19.1**, with shipped product/runtime behavior scoped to PR `#496` and independent-review changes limited to release-integrity safeguards, awaiting protected integration plus final clean-`main` release gates before any tag or publication mutation
