...
- CI runtime maintenance now pins every official Node-based GitHub Action reference to an immutable Node.js 24 release (`checkout` v7.0.1, `setup-node` v5.0.0, `cache` v5.1.0, `upload-artifact` v6.0.0, and `dependency-review-action` v5.0.0); the CI toolchain contract enforces those pins repository-wide and the workflows require Actions Runner 2.327.1 or newer.
