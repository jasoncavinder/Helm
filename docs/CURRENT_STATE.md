...
- prepared maintenance candidate: **0.19.1**, scoped to PR `#496` and awaiting protected integration plus final clean-`main` release gates before any tag or publication mutation
