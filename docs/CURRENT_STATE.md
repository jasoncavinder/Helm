...
- prepared stable source candidate: **0.19.0**; workspace versioning, consolidated release notes, and stable release contracts are prepared on `dev`, but protected integration and every clean-`main` release gate remain pending
...
0.13.x through 0.18.2 stable checkpoints are complete on `main`; `v0.18.0` remains withdrawn, `v0.18.1` is its corrective successor, `v0.18.2` is the final v0.18 containment release, and `v0.19.0` is the prepared stable source candidate awaiting protected integration and final release gates.
