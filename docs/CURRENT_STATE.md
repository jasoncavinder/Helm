...
- RC7 candidate readiness completed on 2026-08-15 from merged `dev` revision `16127dfff2050a2ba2d8b0b3502e110ab4460080`: focused connectivity QA, the full quality gate, 153 arm64 macOS tests, release/appcast contracts, and non-mutating release checks passed; version preparation and all clean-`main` release gates remain pending
