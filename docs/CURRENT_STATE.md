...
- prepared source candidate: **0.19.0-rc.3**; it is not tagged or published, and public beta/RC metadata remains on `v0.19.0-rc.2` until publication completes
...
- owner installation validation confirms `/Applications/Helm.app` reached the signed Developer ID `0.19.0-rc.2` build through Sparkle; this is one successful owner installation/update-path validation, not broad participant validation.
