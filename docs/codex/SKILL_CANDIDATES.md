...
- Priority Score: `9.32`
- Repeated Entries: `2`
- Dominant Components: `core/rust, apps/macos-ui, dev/logs, skills/audit-remediation-batch`
...
Purpose:
Standardize a repeated 'operating lean' workflow observed across core/rust, apps/macos-ui, dev/logs, skills/audit-remediation-batch. This candidate is based on 2 similar telemetry entries.

Inputs:
- task objective and expected outcome
- target scope/components (common: core/rust, apps/macos-ui, dev/logs, skills/audit-remediation-batch)
...
2. Gather required context from dominant components (core/rust, apps/macos-ui, dev/logs, skills/audit-remediation-batch).
...
```bash
scripts/codex/draft-skill-from-candidate.sh operating-lean-commands
```
