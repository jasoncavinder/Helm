...
Focus:
- validate the prepared `v0.19.0-rc.2` source candidate without tagging or publishing until owner shell/window QA, protected integration, final `main` gates, and explicit release authorization are complete
