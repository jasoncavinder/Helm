...
- complete the narrowly scoped `0.19.1` retained-Homebrew-keg correction: verify that same-prefix historical kegs do not create false multi-install attention, distinct Homebrew prefixes remain visible, and inactive install entries cannot initiate manager-wide update or uninstall operations
