...
- preserve the Plan's vertical Wayfinder card-list presentation while retaining its native authority-grouped outline, virtualized scrolling, full-row inspector selection, inclusion and vendor actions, keyboard behavior, and bounded confirmation contract
