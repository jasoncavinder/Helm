...
- preserve updater-plan truth: scheduled Helm checks discover availability without presenting Sparkle UI; available Helm updates appear in Library and Plan; the default-off Upgrade All preference runs Helm last through Sparkle's confirmation/relaunch flow; and third-party Sparkle apps remain visible interactive steps rather than falsely counted automatic work
