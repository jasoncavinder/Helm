...
- [ ] Verify Refresh and CLI installation through the final app/XPC service boundary against recovered database copies.
- [ ] Run targeted SQLite, doctor/repair, Rust workspace, macOS UI/service, documentation, web, and release-contract checks after rebasing onto withdrawal-complete `main`.
- [ ] Run the non-mutating `v0.18.1` release rehearsal.
