...
1. 1.1: entitlement scaffolding + managed bootstrap + policy snapshot store
2. 1.2: scoped policy evaluation + drift detection + compliance reporting
3. 1.3: rollout rings + approvals + audit export integrations
