...
TEMPLATE_PATH="$ROOT_DIR/.opencode/skills/skill-generator/templates/SKILL.template.md"
SKILLS_ROOT="$ROOT_DIR/.opencode/skills"
...
Options:
      ...
      --skills-root <path>      Override skills root directory (default: $ROOT_DIR/.opencode/skills)
...
echo "[skill-generator] next step: update AGENTS.md skill catalog with invocation guidance for '$SKILL_NAME'"
