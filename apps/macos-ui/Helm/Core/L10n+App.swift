    ...
    struct App {
        ...
        struct Managers {
            ...
            struct Research {
                ...
                static let datasetUnavailable = "app.managers.research.dataset_unavailable"
                ...
                static let detailsExpanded = "app.managers.research.instance.details_expanded"
                static let detailsCollapsed = "app.managers.research.instance.details_collapsed"
        ...
        struct Updates {
            ...
            static let openAppToUpdate = "app.updates.action.open_app_to_update"
            static let sparkleOpenFailed = "app.updates.sparkle_open_failed"
        ...
        struct Inspector {
            ...
            static let descriptionLoading = "app.inspector.description_loading"
            static let descriptionUnavailable = "app.inspector.description_unavailable"
            ...
            static let copyAll = "app.inspector.copy_all"
            ...
            static let packageRuntimeState = "app.inspector.package_runtime_state"
            static let packageRuntimeStateActive = "app.inspector.package_runtime_state.active"
            static let packageRuntimeStateDefault = "app.inspector.package_runtime_state.default"
            static let packageRuntimeStateOverride = "app.inspector.package_runtime_state.override"
            static let rustupComponents = "app.inspector.rustup_components"
            static let rustupTargets = "app.inspector.rustup_targets"
            static let rustupDetailLoading = "app.inspector.rustup_detail_loading"
            static let rustupDetailUnavailable = "app.inspector.rustup_detail_unavailable"
            static let rustupNoneInstalled = "app.inspector.rustup_none_installed"
            static let rustupInstalledOfAvailable = "app.inspector.rustup_installed_of_available"
            static let rustupProfile = "app.inspector.rustup_profile"
            static let rustupSetProfile = "app.inspector.rustup_set_profile"
            static let rustupSetDefault = "app.inspector.rustup_set_default"
            static let rustupOverrides = "app.inspector.rustup_overrides"
            static let rustupNoOverrides = "app.inspector.rustup_no_overrides"
            static let rustupOverridesConfigured = "app.inspector.rustup_overrides_configured"
            static let rustupSetOverride = "app.inspector.rustup_set_override"
            static let rustupClearOverride = "app.inspector.rustup_clear_override"
            static let rustupAddComponent = "app.inspector.rustup_add_component"
            static let rustupRemoveComponent = "app.inspector.rustup_remove_component"
            static let rustupAddTarget = "app.inspector.rustup_add_target"
            static let rustupRemoveTarget = "app.inspector.rustup_remove_target"
            static let rustupConfiguring = "app.inspector.rustup_configuring"
            ...
            static let executablePathUseDefault = "app.inspector.executable_path.use_default"
            static let executablePathTagDefault = "app.inspector.executable_path.tag.default"
